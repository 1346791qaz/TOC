...
function buildApp() {
  ...
  // Connection-specific actions (test, schema-browse) for db_connections.
  // The generic CRUD for db_connections is handled above via ENTITY_KEYS.
  app.use("/api/db_connections", connectionsRouter());
